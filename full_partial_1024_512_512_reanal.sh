...
python3 main.py --env Hanabi-Full --case hanabi --opr train --seed 1 --num_gpus 3 --num_cpus 42 --force --batch_actor 12 \
  --p_mcts_num 8\
  --extra full_2p_test\
  --use_priority \
  --use_max_priority \
  ...
  --info 'full_2_player_partial_new_model_1024_512_512' \
  --actors 2 \
  --simulations 100 \
  --batch_size 128
#  --load_model \
