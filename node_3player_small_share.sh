...
python3 main.py --env Hanabi-Small --case hanabi --opr train --seed 1 --num_gpus 2 --num_cpus 40 --force --batch_actor 26 \
  --p_mcts_num 16\
  --extra small_partial_obs_best_model_revert_share\
  --use_priority \
  --use_max_priority \
