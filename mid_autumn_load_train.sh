...
python3 main.py --env hanabi --case hanabi --opr train --seed 1 --num_gpus 2 --num_cpus 72 --force --batch_actor  7\
  --p_mcts_num 16\
  --extra continue_830k_test \
  --use_priority \
  --use_max_priority \
  ...
  --load_model \
  --model_path /home/game/mid_autumn_best_model/model_830000.p
#  --load_model \
