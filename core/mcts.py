    ...
    def run_multi(self, roots, model, hidden_state_roots):
        ...
        with torch.no_grad():
            ...
            for index_simulation in range(self.config.num_simulations):
                ...
                hidden_state_index_x_lst, hidden_state_index_y_lst, last_actions = tree.multi_traverse(
                ...
                last_actions = torch.from_numpy(np.asarray(
                    last_actions)).to('cuda').unsqueeze(1).long()
