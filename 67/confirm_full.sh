...
#58
#46/9
python3 ../main.py --env Hanabi-Full --case hanabi --opr train --seed 10 --num_gpus 4 --num_cpus 80 --force --batch_actor 49\
  --p_mcts_num 40\
  ...
  --info 'full_share_rescale_legel_1_stack_td_5_sim_60' \
  --actors 14 \
  --simulations 60 \
  --batch_size 256 \
  --val_coeff 0.25 \
