...
python3 main.py --env Hanabi-Small --case hanabi --opr test --seed 99 --num_gpus 2 --num_cpus 40 --force --batch_actor 7 \
  --p_mcts_num 16\
  --extra test_full \
  --use_priority \
  --use_max_priority \
  ...
  --info 'hanabi_small_noise_aux_new' \
  --load_model \
  --model_path ./test/model_partial \
  --test_begin 1 \
  --test_end 25 
#  --load_model \
